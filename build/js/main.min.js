...
/* harmony import */ var _video__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./video */ "./js/video.js");
/* harmony import */ var _modules_offers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/offers */ "./js/modules/offers.js");
/* harmony import */ var _modules_feedback__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/feedback */ "./js/modules/feedback.js");
...
var coachSwiper = document.querySelector('.coaches__swiper-wrapper');

var initCoachSwiper = function initCoachSwiper() {
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  _video__WEBPACK_IMPORTED_MODULE_2__["playButton"].addEventListener('click', function () {
    Object(_video__WEBPACK_IMPORTED_MODULE_2__["onPlayButtonHendler"])();
  });
  _modules_offers__WEBPACK_IMPORTED_MODULE_3__["controlList"].addEventListener('click', function (evt) {
    var element = evt.target;
    Object(_modules_offers__WEBPACK_IMPORTED_MODULE_3__["setOffersList"])(element);
  });
  _modules_form__WEBPACK_IMPORTED_MODULE_5__["phoneField"].addEventListener('input', function () {
    Object(_modules_form__WEBPACK_IMPORTED_MODULE_5__["onPhoneFieldInput"])(_modules_form__WEBPACK_IMPORTED_MODULE_5__["phoneField"].value);

    if (_modules_form__WEBPACK_IMPORTED_MODULE_5__["phoneField"].value.length < PHONE_LENGTH) {
      _modules_form__WEBPACK_IMPORTED_MODULE_5__["phoneField"].setCustomValidity('Ввести 10 цифр.');
    } else {
      _modules_form__WEBPACK_IMPORTED_MODULE_5__["phoneField"].setCustomValidity('');
    }

    ;
    _modules_form__WEBPACK_IMPORTED_MODULE_5__["phoneField"].reportValidity();
  });
  _modules_form__WEBPACK_IMPORTED_MODULE_5__["phoneField"].addEventListener('focus', _modules_form__WEBPACK_IMPORTED_MODULE_5__["onPhoneFieldFocus"]);
  _modules_form__WEBPACK_IMPORTED_MODULE_5__["pageForm"].addEventListener('submit', function (evt) {
    if (_modules_form__WEBPACK_IMPORTED_MODULE_5__["phoneField"].value.split('').length < PHONE_LENGTH) {
      evt.preventDefault();
    }
  });
  ...
  swiper.slideNext();
  _modules_feedback__WEBPACK_IMPORTED_MODULE_4__["feedbackSwiper"].slideNext(); // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_offers__WEBPACK_IMPORTED_MODULE_3__["initOffersList"])();
    initCoachSwiper();
  });
}); // ---------------------------------
...
/*!****************************!*\
  !*** ./js/modules/form.js ***!
  \****************************/
/*! exports provided: phoneField, pageForm, onPhoneFieldInput, onPhoneFieldFocus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "phoneField", function() { return phoneField; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pageForm", function() { return pageForm; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onPhoneFieldInput", function() { return onPhoneFieldInput; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onPhoneFieldFocus", function() { return onPhoneFieldFocus; });
var pageForm = document.querySelector('.contact__form');
var phoneField = pageForm.querySelector('input[type="tel"]');
var CODE_COUNTRY = '+7';

var onPhoneFieldFocus = function onPhoneFieldFocus() {
  phoneField.value = CODE_COUNTRY;
};

var onPhoneFieldInput = function onPhoneFieldInput(phone) {
  var arr = phone.split('');
  var newArr = phone.split('');
  phoneFieldChange(arr, newArr);
  phoneField.value = arr.join('');
};

var phoneFieldChange = function phoneFieldChange(arr, newArr) {
  if (isNaN(newArr.pop())) {
    arr.pop();
  }
...
/*!******************************!*\
  !*** ./js/modules/offers.js ***!
  \******************************/
/*! exports provided: controlList, setOffersList, initOffersList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "controlList", function() { return controlList; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setOffersList", function() { return setOffersList; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initOffersList", function() { return initOffersList; });
var controlList = document.querySelector('.offers__control-list');
var controlButtons = controlList.querySelectorAll('.offers__control-item');
var offersSection = document.querySelector('.offers');
var offersList = offersSection.querySelectorAll('.offers__list');
var PERIOD_SIX = '6 months';
var PERIOD_TWELVE = '12 months';

var initOffersList = function initOffersList() {
...
var setOffersList = function setOffersList(element) {
...
/*!*********************!*\
  !*** ./js/video.js ***!
  \*********************/
/*! exports provided: onPlayButtonHendler, playButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onPlayButtonHendler", function() { return onPlayButtonHendler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "playButton", function() { return playButton; });
var videoContent = document.querySelector('.promo__video video');
var playButton = document.querySelector('.promo__video button');

var onPlayButtonHendler = function onPlayButtonHendler() {
  videoContent.play();
};
